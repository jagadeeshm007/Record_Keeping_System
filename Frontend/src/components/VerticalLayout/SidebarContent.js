          ...
          <li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                {users && users.TrainerId.length !== 4 && (
                <li>
                  ...
                  {users && users.TrainerId.length !== 4 && (
                  <li>
                  <Link to="/createuser">{props.t("Add Trainer")}</Link>
                </li>
                  )}
            ...
            <li>
              ...
              <ul className="sub-menu">
                {/* <li>
                  ...
                  {users && users.TrainerId.length <=5 &&  (
                <li>
                  <Link to="/permissions">{props.t("Permissions")}</Link>
                </li>
                  )}
                <li>
                  <Link to="/Allpermissions">{props.t("AllPermissions")}</Link>
                </li>
                <li>
                  <Link to="/Accepted">{props.t("Accepted")}</Link>
                </li>
                <li>
                  <Link to="/Denied">{props.t("Denied")}</Link>
                </li>
                {/* <li>
